        ...
        >
            <Box p={2} maxWidth={500}>
                ...
                <Typography variant="body2" paragraph>
                    1. <strong>Travel Time Adjustment</strong>: Your available time slots will be adjusted to account
                    for your travel time. For example, if you set your availability from 10:00 to 16:00 and your travel
                    time is 30 minutes, your available slots for customers will be from 10:30 to 15:30.
                </Typography>
                <Typography variant="body2" paragraph>
                    2. <strong>Default (Minimum) Slot Duration</strong>: Only slots that are equal to or longer than
                    your default service duration will be shown to customers. Ensure your selected availability can
                    accommodate your default duration to avoid having no visible slots.
                </Typography>
                <Typography variant="body2">
                    <em>Example:</em> If you are available from 10:00 to 16:00 with a 30-minute transit time and a
                    1-hour default duration, the available slots shown to customers will be from 10:30 to 3:30 PM, and
                    they have to book a slot no shorter than 1 hour.
                </Typography>
            </Box>
        </Popover>
    )
