...
const FAQPage = () => {
    ...
    const faqs = [
        ...
        { question: "What does it mean to upgrate to Pro?", answer: "By upgrading to Pro to make sure that your service offerings get more visibility, by appearing at the top of the search results." },
        ...
        { question: "Why can't I find my city?", answer: "We currently offer services only in specific cities within Germany. If your city does not appear in the filter options, it means we do not provide services in that location at this time. If your city is on the list but there are no service offerings in the area, you can always be the first one to provide a service in the city!" },
    ];
